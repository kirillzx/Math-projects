...
\begin{figure}[ht]
\center{\includegraphics[scale=0.3]{images/image1.png}}
\caption{Test image}
\label{figure:image}
\end{figure}
% \begin{figure}[h]
% \begin{minipage}[h]{0.49\linewidth}
% \center{\includegraphics[width=0.5\linewidth]{images/image1.png} \\ а)}
% \end{minipage}
% \hfill
% \begin{minipage}[h]{0.49\linewidth}
% \center{\includegraphics[width=0.5\linewidth]{images/image1.png} \\ б)}
% \end{minipage}
